...
class StoresTest < ApplicationSystemTestCase
  ...
  test "creating a Store" do
    ...
    fill_in "Recipe calories", with: @store.recipe_calories
    fill_in "Recipe description", with: @store.recipe_description
    fill_in "Recipe name", with: @store.recipe_name
    fill_in "Recipe price", with: @store.recipe_price
